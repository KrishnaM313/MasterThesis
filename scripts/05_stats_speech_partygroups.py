...
if __name__ == '__main__':
    ...
    for category in ["climate", "health"]:
        ...
        fileAnalysisPath = os.path.join(
            analysisSummaryDir, "{category}.csv".format(category=category))
        ...
        df['politicalGroupIdeology'] = df['politicalGroupIdeology'].str.replace(
            'Christian democrats and conservatives', 'Christian democ. and cons.')
